...
import citizenKaneImg from "../assets/heroImage/citizenKaneImg.png";
...
export const roles: Role[] = [
...

  {
    ...
    name: "جادوگر",
    description: [
      "اولین نفر اکشن‌دار در شب است مافیا.",
...

  {
    ...
    name: "فرشته",
    description: [
      "فرشته یک بار در کل بازی می‌تواند در شب، یک نفر را که از بازی حذف شده است به بازی برگرداند.",
  ...
  },
  {
    ...
    description: [
      "عضو تیم شهروندان.",
      "در یکی از شب‌ها (به انتخاب خودش) به گرداننده اشاره می‌کند تا نقش یک بازیکن را بررسی کند.",
      "اگر نقش نشان‌داده‌شده مافیا باشد، صبح روز بعد گرداننده نام آن مافیا را به‌صورت عمومی اعلام می‌کند.",
      "در این حالت، همشهری کین در شب بعد توسط مافیا کشته می‌شود و هیچ‌کس قادر به نجات او نیست.",
      "اگر نقش بررسی‌شده مافیا نباشد، گرداننده هیچ اطلاعاتی اعلام نمی‌کند.",
      "در صورت اشتباه، همشهری کین در بازی باقی می‌ماند ولی توانایی استعلام خود را از دست می‌دهد.",
      "اگر همشهری کین قبل از استفاده از توانایی‌اش کشته شود، عملیات شبانه‌ی او اجرا نمی‌شود.",
      "استعلام برای همشهری کین بدمصرف است و فقط یک‌بار در کل بازی قابل استفاده است.",
    ].join("\n"),
    image: citizenKaneImg,
    faction: "city",
    actions: ["investigate"],
  },
...

  {
    ...
    description: [
      ...
      "اگر گادفادر از بازی خارج شود، تیم مافیا دیگر هیچ سلاخی‌ای در شب ندارد.",
...

  {
    ...
    description: [
      "عضو تیم مافیا.",
      "هر شب بیدار می‌شود و یک نفر را انتخاب می‌کند.",
      "اگر در روز از بازی خارج شود، در همان شب دوباره بیدار می‌شود و می‌تواند یک نفر را به طور مستقیم از بازی حذف کند.",
    ].join("\n"),
    image: terroristImg,
    faction: "mafia",
    actions: ["revengeOnVoteOut"],
